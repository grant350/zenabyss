...
return (
  <div className="profile-description" style={{padding:'20px'}}>
      ...
      <div style={{textAlign:'left',display:'inline-block'}}><span className="bold" style={{textAlign:'left',display:'inline-block',margin:'0 10px'}}>How this site was built?:  </span> <p className='skill-content'>This site was built using Node.js to serve client pages. React to render components to the dom. MongoDB to store information as documents. </p></div>
